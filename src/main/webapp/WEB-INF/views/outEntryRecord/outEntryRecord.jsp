    ...
    <div class="example-wrap">
        ...
        <div class="example">
            <div class="btn-group hidden-xs" id="exampleToolbar" role="group" style="width: 170%">
                ...
                <button id="addOutEntryRecordBtn" type="button" class="btn btn-outline btn-default">
                    <i class="glyphicon glyphicon-plus" aria-hidden="true"></i>新增出入记录
                </button>
            </div>
        </div>
        <div class="example-wrap">
            <div>
                <table id="outEntryRecordTable">
                </table>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-lg" data-animation="fadeInUp">
                <div class="modal-content animated bounceInRight">
                    ...
                    <div class="modal-body" style="height: 160px;">
                        <form method="post" id="addOutEntryRecordForm">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input type="hidden" id="dormitoryId" name="dormitoryId" class="form-control" readonly="readonly">
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" readonly="readonly" maxlength="3" id="roomOrd" name="roomOrd" class="form-control" placeholder="请输入文本">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">携带物品：</label>
                                    <div class="col-sm-9">
                                        <input type="text" id="belonging" name="belonging" class="form-control" >
                                    </div>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-white" data-dismiss="modal">关闭</button>
                        <button type="button" class="btn btn-primary" id="submitRecord">确定</button>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript" src="${basePath}/resources/js/outEntryRecord/outEntryRecord.js" ></script>
</body>
</html>
